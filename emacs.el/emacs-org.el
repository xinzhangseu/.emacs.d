...
(setq org-publish-project-alist
      '(
        ("org-notes2011anal-org"
         ...
         :html-head "<script type=\"text/javascript\" src=\"http://xzhang.imwork.net:6789/notes/css/org-script.js\"></script>"
         :html-head "<link href=\"http://xzhang.imwork.net:6789/notes/css/readtheorg.css\" rel=\"stylesheet\" type=\"text/css\" />"
         :recursive t
         :publishing-function org-html-publish-to-html
         :headline-levels 4             ;; Just the default for this project.
         :auto-preamble t
...
("org-notes2011anal-pdf"
         :base-directory "~/Sync/Dropbox/Emacs/Org/"
         :base-extension "org"
         :publishing-directory "~/Sync/Dropbox/Emacs/Org/"
         ;;:recursive t
        ...
        ("org-notes2011anal-upload"
         ...
         :publishing-directory "/xzhangweb@alsichkann.f3322.net:/volume1/web/notes/"
         :recursive t
         :publishing-function org-publish-attachment)
