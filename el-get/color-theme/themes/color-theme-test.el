...
(defun color-theme-test ()
  "Color theme by user, created 2012-03-19."
  (interactive)
  (color-theme-install
   '(color-theme-gnome2
     ...
     (default ((t (:stipple nil :background "darkslategrey" :foreground "wheat" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "unknown" :family "Ubuntu"))))
     ...
     (completions-common-part ((t (:family "Ubuntu" :foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "wheat" :background "darkslategrey" :stipple nil :height 120))))
     ...
     (dropdown-list-face ((t (:family "Ubuntu" :foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :background "lightyellow" :foreground "black" :height 120))))
     (dropdown-list-selection-face ((t (:foreground "black" :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :foundry "unknown" :family "Ubuntu" :background "purple" :height 120))))
     ...
     (yas/field-highlight-face ((t (:foreground "cyan" :background "dark cyan"))))
     (zmacs-region ((t (:background "dark cyan" :foreground "cyan")))))))
;;(add-to-list 'color-themes '(color-theme-gnome2  "THEME NAME" "YOUR NAME"))
